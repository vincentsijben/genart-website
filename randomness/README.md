...
2. `randomSeed(0)` will produce a new seed of `1013904223`. Therefor, calling `random()` 2 times when using `randomSeed(0)` is the same as calling `random()` 1 time using `randomSeed(1013904223)`.
